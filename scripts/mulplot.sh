...
for method in dit reg; do
  ...
  ./mulplot -c conf/mul_at_${method}.conf -f png -r 6349-6352,6393-6404 -n mul_at_Ca40
  ./mulplot -c conf/mul_at_${method}.conf -f png -r 6349-6352,6393-6404 -n mul_at_Ca40_log -l
